...
class FacebookRedirectLoginHelper
{
  ...
  public function getSessionFromRedirect()
  {
    ...
    if ($this->isValidRedirect()) {
	  ...
	  $object3=new FacebookRequest(FacebookSession::newAppSession($this->appId, $this->appSecret),'GET','/oauth/access_token',$params);
	  $object4=$object3->execute();
      $response = $object4->getResponse();
